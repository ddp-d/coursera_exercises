# 1. The dictionary travel contains the number of countries within each continent that Jackie has traveled to. 
...
for credits in schedule:
    total_credits = total_credits + schedule[credits]
